...
function showQuickLook(card) {
    const quickLookButton = card.querySelector('.quick-look');
    quickLookButton.style.opacity = '1';
    quickLookButton.style.bottom = '10px';
}

function hideQuickLook(card) {
    const quickLookButton = card.querySelector('.quick-look');
    quickLookButton.style.opacity = '0';
    quickLookButton.style.bottom = '-50px';
}
